...
import { VoiceSentinelConsole } from "./components/VoiceSentinelConsole";
...
import { Cpu, ShieldCheck, Sparkles, Terminal, Activity, PhoneCall } from "lucide-react";

export default function App() {
  const [activeTab, setActiveTab] = useState<"voice_sentinel" | "pqc_shield" | "shor_lab" | "circuit_studio" | "bitcoin_arena" | "solana_relayer" | "anna_executa">("voice_sentinel");
